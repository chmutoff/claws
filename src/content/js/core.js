...
nvdaText.getNvdaText = function(node){
  ...
  switch(tagName){
    ...
    case 'Q':
      return ''
    case 'SELECT':
      return NVDAStringBundle.getString('NVDA.output.select')
    case 'TABLE':
...
nvdaText.getClosingNvdaText = function(node){
  var NVDAStringBundle = document.getElementById('NVDA-string-bundle');
  var tagName = node.tagName.toUpperCase()
  switch (tagName) {
    case 'BLOCKQUOTE':
...
nvdaText.getInputNvdaText = function(node){
  var NVDAStringBundle = document.getElementById('NVDA-string-bundle');
  ...
  getNvdaText : function(node){
    ...
    switch(tagName){
      ...
      case 'DATALIST':
        return NVDAStringBundle.getString('NVDA.output.datalist')
      case 'DL':
        return NVDAStringBundle.getFormattedString('NVDA.output.list', [generalText.countListNodes(node)])
      case 'FOOTER':
        if (node.parentNode.nodeName == 'BODY') {
          // NVDA only anounces the page footer
          return NVDAStringBundle.getString('NVDA.output.body.footer')
      ...
      case 'SELECT':
        return NVDAStringBundle.getString('NVDA.output.select')
      case 'TABLE':
        return NVDAStringBundle.getFormattedString('NVDA.output.table', [generalText.getNumRowsInTable(node), generalText.getNumCellsInTable(node)])
      case 'TD':
        return generalText.getCellHeading(node) + ' ' +  NVDAStringBundle.getFormattedString('NVDA.output.table.column', [(node.cellIndex+1)])
      case 'TEXTAREA':
        return NVDAStringBundle.getString('NVDA.output.textarea')
      case 'TH':
        return generalText.getCellHeading(node) + ' ' +  NVDAStringBundle.getFormattedString('NVDA.output.table.column', [(node.cellIndex+1)])
