...
pref("extensions.claws.output.quote", true);
pref("extensions.claws.output.address", true);
pref("extensions.claws.output.claws.mode.title", true);
pref("extensions.claws.output.background.color", "#FFFFFF");                //White background
